...
const CreateTransactionMonitorPayloadType = new GraphQLObjectType({
  name: 'CreateTransactionMonitorPayload',
  fields: {
    transactionMonitor: {
...
export default {
  name: 'createTransactionMonitor',
  type: CreateTransactionMonitorPayloadType,
  args: {
